...
public class GetSuccessTripTouristResponse {
    ...
    public Response responseGetSuccessTripTourist(){
        ...
        Response responseTripTourist = getMemberGetMessagesChatKey.parametrizeGetRequest(accessToken, getRequest + tripId);
        return responseTripTourist;
    }
